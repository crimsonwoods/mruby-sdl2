...
mruby_sdl2_video_init(mrb_state *mrb)
{
  ...
  mrb_define_module_function(mrb, mod_Video, "init", mrb_sdl2_video_init, ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_Video, "quit", mrb_sdl2_video_quit, ARGS_NONE());
  mrb_define_module_function(mrb, mod_Video, "screen_saver?", mrb_sdl2_video_get_screen_saver_enabled, ARGS_NONE());
  mrb_define_module_function(mrb, mod_Video, "screen_saver=", mrb_sdl2_video_set_screen_saver_enabled, ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_Video, "video_drivers", mrb_sdl2_video_get_video_drivers,        ARGS_NONE());
  mrb_define_module_function(mrb, mod_Video, "display_modes", mrb_sdl2_video_get_display_modes,        ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_Video, "displays",      mrb_sdl2_video_get_displays,             ARGS_NONE());

  mrb_define_module_function(mrb, mod_GL, "attribute_get",        mrb_sdl2_video_gl_get_attribute,          ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_GL, "attribute_set",        mrb_sdl2_video_gl_set_attribute,          ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_GL, "extension_supported?", mrb_sdl2_video_gl_is_extension_supported, ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_GL, "swap_interval",        mrb_sdl2_video_gl_get_swap_interval,      ARGS_NONE());
  mrb_define_module_function(mrb, mod_GL, "swap_interval=",       mrb_sdl2_video_gl_set_swap_interval,      ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_GL, "swap_window",          mrb_sdl2_video_gl_swap_window,            ARGS_REQ(1));

  mrb_define_method(mrb, class_Window, "initialize",           mrb_sdl2_video_window_initialize,           ARGS_OPT(6));
  mrb_define_method(mrb, class_Window, "create",               mrb_sdl2_video_window_create,               ARGS_REQ(6));
  mrb_define_method(mrb, class_Window, "create_with_renderer", mrb_sdl2_video_window_create_with_renderer, ARGS_REQ(3));
  mrb_define_method(mrb, class_Window, "destroy",              mrb_sdl2_video_window_destroy,              ARGS_NONE());
  mrb_define_method(mrb, class_Window, "size",                 mrb_sdl2_video_window_get_size,             ARGS_NONE());
  mrb_define_method(mrb, class_Window, "size=",                mrb_sdl2_video_window_set_size,             ARGS_REQ(1));
  mrb_define_method(mrb, class_Window, "position",             mrb_sdl2_video_window_get_position,         ARGS_NONE());
  ...
  mrb_define_method(mrb, class_Window, "hide",                 mrb_sdl2_video_window_hide,                 ARGS_NONE());
  mrb_define_method(mrb, class_Window, "restore",              mrb_sdl2_video_window_restore,              ARGS_NONE());
  mrb_define_method(mrb, class_Window, "raise",                mrb_sdl2_video_window_raise,                ARGS_NONE());
  mrb_define_method(mrb, class_Window, "make_current",         mrb_sdl2_video_window_make_current,         ARGS_REQ(1));
  mrb_define_method(mrb, class_Window, "icon=",                mrb_sdl2_video_window_set_icon,             ARGS_REQ(1));
  mrb_define_method(mrb, class_Window, "brightness",           mrb_sdl2_video_window_get_brightness,       ARGS_NONE());
  mrb_define_method(mrb, class_Window, "brightness=",          mrb_sdl2_video_window_set_brightness,       ARGS_REQ(1));
  mrb_define_method(mrb, class_Window, "diplay_index",         mrb_sdl2_video_window_get_display_index,    ARGS_NONE());
  mrb_define_method(mrb, class_Window, "display_mode",         mrb_sdl2_video_window_get_display_mode,     ARGS_NONE());
  mrb_define_method(mrb, class_Window, "display_mode=",        mrb_sdl2_video_window_set_display_mode,     ARGS_REQ(1));
  mrb_define_method(mrb, class_Window, "flags",                mrb_sdl2_video_window_get_flags,            ARGS_NONE());
  mrb_define_method(mrb, class_Window, "gamma_ramp",           mrb_sdl2_video_window_get_gamma_ramp,       ARGS_NONE());
  mrb_define_method(mrb, class_Window, "gamma_ramp=",          mrb_sdl2_video_window_set_gamma_ramp,       ARGS_REQ(1));
  mrb_define_method(mrb, class_Window, "grab",                 mrb_sdl2_video_window_get_grab,             ARGS_NONE());
  mrb_define_method(mrb, class_Window, "grab=",                mrb_sdl2_video_window_set_grab,             ARGS_REQ(1));
  mrb_define_method(mrb, class_Window, "id",                   mrb_sdl2_video_window_get_id,               ARGS_NONE());
  mrb_define_method(mrb, class_Window, "maximum_size",         mrb_sdl2_video_window_get_maximum_size,     ARGS_NONE());
  mrb_define_method(mrb, class_Window, "maximum_size=",        mrb_sdl2_video_window_set_maximum_size,     ARGS_REQ(1));
  mrb_define_method(mrb, class_Window, "minimum_size",         mrb_sdl2_video_window_get_minimum_size,     ARGS_NONE());
  mrb_define_method(mrb, class_Window, "minimum_size=",        mrb_sdl2_video_window_set_minimum_size,     ARGS_REQ(1));
  mrb_define_method(mrb, class_Window, "surface",              mrb_sdl2_video_window_get_surface,          ARGS_NONE());
